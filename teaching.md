...
<div class="carousel" data-carousel>
  ...
  <figure data-slide hidden>
    <img src="{{ '/assets/media/seabirds.jpg' | relative_url }}" alt="Seabirds over the ocean.">
    <figcaption>Visible marine life provides an entry point for discussing food webs, observation, and evidence.</figcaption>
  </figure>

  <figure data-slide hidden>
    <img src="{{ '/assets/media/whale.jpg' | relative_url }}" alt="Whale at the ocean surface.">
    <figcaption>Large marine organisms help connect plankton dynamics to broader ecosystem questions.</figcaption>
  </figure>
...
My teaching experience and research background prepare me to contribute across biology, ecology, oceanography, and quantitative environmental science.
